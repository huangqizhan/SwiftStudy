...
class HHotAudioBookChildCell: UICollectionViewCell {
    // 图片
     ...
     var recommendData:HRecommendListModel? {
         didSet{
     ...
     var guessYouLikeModel:HGuessYouLikeModel? {
         didSet{
